      ...
      <div className="hidden lg:flex items-center gap-8">
        ...
        <div className="flex items-center gap-6 ml-4">
          {user ? (
            ...
            <>
              <Link to="/comparison" className="text-[15px] font-medium text-slate-900 hover:underline">Login</Link>
              <Link to="/comparison" className="bg-[#0F172A] text-white py-2.5 px-6 rounded-full text-sm font-bold flex items-center gap-2 hover:bg-slate-800 transition-all">
